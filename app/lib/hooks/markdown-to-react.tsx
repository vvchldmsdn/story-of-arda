...
import DetailLinkArrow from "@/app/ui/atoms/DetailLinkArrow";
import { useSearchParams, usePathname, useRouter } from 'next/navigation';

export const convertMarkdownToReact = (markdown: string, overview: string) => {
                    ...
                    <CardHeader className="pb-0 pt-2 px-4 flex-col items-start flex justify-center">
                      <div className="whitespace-normal w-full">
                        <div className="flex justify-between items-center mb-4 text-eeeeee w-full">
                          ...
                          <DetailLinkArrow subject={domNode.attribs.href}></DetailLinkArrow>
                        </div>
  ...
  return parse(converter.makeHtml(markdown), options);
};